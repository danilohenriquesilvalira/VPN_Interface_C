...
static const app_gsdml_module_t module_rls_monitor = {
   .id = APP_GSDML_MOD_ID_RLS_MONITOR,
   .name = "RLS Monitor",
   .submodules = {APP_GSDML_SUBMOD_ID_RLS_MONITOR, 0}};

static const app_gsdml_module_t module_rls_control = {
   .id = APP_GSDML_MOD_ID_RLS_CONTROL,
   .name = "RLS Control",
   .submodules = {APP_GSDML_SUBMOD_ID_RLS_CONTROL, 0}};
...
static const app_gsdml_submodule_t submod_rls_monitor = {
   .id = APP_GSDML_SUBMOD_ID_RLS_MONITOR,
   .name = "RLS Monitor",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_INPUT,
   .insize = APP_GSDML_INPUT_DATA_MONITOR_SIZE,
   .outsize = 0,
   .parameters = {0}};

static const app_gsdml_submodule_t submod_rls_control = {
   .id = APP_GSDML_SUBMOD_ID_RLS_CONTROL,
   .name = "RLS Control",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_OUTPUT,
   .insize = 0,
   .outsize = APP_GSDML_OUTPUT_DATA_CONTROL_SIZE,
   .parameters = {0}};
