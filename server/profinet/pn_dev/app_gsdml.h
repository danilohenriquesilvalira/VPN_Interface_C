...
#define APP_GSDML_DEFAULT_STATION_NAME "rls-minipc"

/* GSDML tag: VendorID */
#define APP_GSDML_VENDOR_ID 0x0175
...
/* === RLS MiniPC Project Modules === */

/* Module 0x50: RLS Monitor - 16 bytes IN (Raspberry -> PLC)
 *   Byte  0: Status flags
 *             b0=WiFi ligado  b1=ZeroTier ONLINE  b2=ZeroTier rede OK
 *             b3=SoftEther activo  b4=eth0 tem IP  b5=Internet OK
 *   Byte  1: WiFi rede activa (0=nenhuma 1=P300 2=RLS-5G 3=iPhone Danilo)
 *   Byte  2: eth0 IP octeto 1
 *   Byte  3: eth0 IP octeto 2
 *   Byte  4: eth0 IP octeto 3
 *   Byte  5: eth0 IP octeto 4
 *   Byte  6: SoftEther sessoes activas
 *   Byte  7: WiFi visiveis b0=P300 b1=RLS-5G b2=iPhoneDanilo
 *   Bytes 8-15: Reservado
 */
#define APP_GSDML_MOD_ID_RLS_MONITOR       0x00000050
#define APP_GSDML_SUBMOD_ID_RLS_MONITOR    0x00000150
/* Byte 0: Status flags (WiFi=b0, ZT_Online=b1, ZT_Net=b2, SE=b3, eth0=b4, Internet=b5)
 * Byte 1: WiFi rede activa (0=nenhuma 1=P300 2=RLS-5G 3=iPhone Danilo)
 * Byte 2: SoftEther sessoes activas
 * Byte 3: WiFi visiveis (b0=P300 b1=RLS-5G b2=iPhoneDanilo)
 */
#define APP_GSDML_INPUT_DATA_MONITOR_SIZE  4

/* Module 0x51: RLS Control - 4 bytes OUT (PLC -> Raspberry)
 * Byte 0: Flags comando (b0=LigarWiFi b1=ReiniciarZT b2=ReiniciarSE)
 * Byte 1: Indice WiFi (1=P300 2=RLS-5G 3=iPhone Danilo)
 * Bytes 2-3: Reservado
 */
#define APP_GSDML_MOD_ID_RLS_CONTROL       0x00000051
#define APP_GSDML_SUBMOD_ID_RLS_CONTROL    0x00000151
#define APP_GSDML_OUTPUT_DATA_CONTROL_SIZE 4
...
#define APP_GSDML_INPUT_DATA_DIGITAL_SIZE   2 /* bytes */
#define APP_GSDML_OUTPUT_DATA_DIGITAL_SIZE  2 /* bytes */
